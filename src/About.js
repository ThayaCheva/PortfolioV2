    ...
    return (
        <section id="about" onMouseMoveCapture={props.hoverFunction}>
            <div className="about-container">
                ...
                <p>Hi! I'm a Computing and Software Systems student at the University of Melbourne from Thailand. I possess a strong passion for graphic design and front-end development. I've also developed various software projects, ranging from games to websites. Please check out my projects, and feel free to get in touch for collaboration opportunities.</p>
